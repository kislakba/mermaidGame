...
class Bullet():
    def __init__(self,plane):
        ...
        self.mx=0.0
        self.my=0.0
        self.rectangle=pygame.rect.Rect(plane.rectangle[0] + plane.rectangle[2]/2, plane.rectangle[1] + int(plane.rectangle[3] / 2), int(plane.rectangle[2] / 5), int(plane.rectangle[3] / 5))
